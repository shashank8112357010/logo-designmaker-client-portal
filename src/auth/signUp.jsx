...
import { CheckEmail } from './CheckEmail.jsx'; // Import the CheckEmail component
...
export function SignUp() {
  ...
  const [isSubmitted, setIsSubmitted] = useState(false); // State to toggle between form and check email
  ...
  const handleSubmit = (e) => {
    ...
    if (isValidPassword) {
      setIsSubmitted(true); // Show CheckEmail component on submit
    } else {
  ...
  return (
    <section className="relative bg-secondaryBlack min-h-screen flex">
      <div className="w-1/3 bg-primaryBlack fixed top-0 left-0 h-full p-10 flex flex-col justify-between">
        <div>
          <img
            src="/img/Logo.png"
            className="h-14 w-64"
          ...
          <div className="mt-20">
            ...
            <h1 className="text-white text-4xl font-bold">journey with us!</h1>
          </div>
         
        </div>
        <div>
        <div className="flex justify-center my-6 ml-[-260px]">
          <div className="flex space-x-6">
            <div className="w-8 h-8 bg-secondaryBlack rounded-full"></div>
            <div className="w-8 h-8 bg-secondaryBlack rounded-full"></div>
            <div className="w-8 h-8 bg-secondaryBlack rounded-full"></div>
            <div className="w-8 h-8 bg-secondaryBlack rounded-full"></div>
          </div>
        ...
        <div className="flex justify-center mb-[-30px] ml-[-260px]">
          <div className="flex space-x-6">
            <div className="w-8 h-8 bg-secondaryBlack rounded-full"></div>
            <div className="w-8 h-8 bg-secondaryBlack rounded-full"></div>
            <div className="w-8 h-8 bg-secondaryBlack rounded-full"></div>
      ...
      <div className="ml-[33.36%] w-2/3 overflow-y-auto p-10">
        {isSubmitted ? (
          <CheckEmail />
        ) : (
          <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <form className="mt-8 mb-2 w-80 max-w-screen-lg lg:w-1/2" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center  mt-8">
                <input type="checkbox" id="exclude-emails" className="mr-2 mt-[-35px]" />
                <p htmlFor="exclude-emails" className="text-gray-600 text-sm text- font-semibold">
