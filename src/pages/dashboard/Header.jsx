...
const Header = () => {
    return (
        <header className="flex flex-col lg:flex-row items-start lg:items-center justify-between p-2 mb-8 bg-primaryBlack border-b-2 border-secondaryBlack h-16 lg:h-16 top-0 z-50">
